...
public class ajout_recette extends JFrame {
	...
	public ajout_recette() {
		...
		label_1 = new Label("R\u00E9cette");
		label_1.setFont(new Font("Times New Roman", Font.ITALIC, 46));
		label_1.setBounds(177, 10, 183, 49);
